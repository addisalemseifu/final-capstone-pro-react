...
export const getLocation = createAsyncThunk('location/getLocation', (searchval = 'London') => fetch(`http://api.weatherapi.com/v1/forecast.json?key=5175c5cfe42a44b88ef104519233105&q=${searchval}&days=3`)
  .then((res) => res.json())
  .catch((err) => err));
